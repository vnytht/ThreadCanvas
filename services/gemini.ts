...
export const generateInitialTitle = async (
    ...
    preferredBackend: 'GEMINI' | 'OLLAMA'
     ...
     const prompt = `Summarize this conversation context into a concise 2-3 word title for a table of contents. Do not use quotes or prefixes like "Title:". Text: ${text}`;
