...
export interface Message {
  ...
  prevSibling?: Message;
  nextSibling?: Message;
  isComposedContext?: boolean; // True for nodes created by the Selective Context Composer
  sourceNodeIds?: string[]; // IDs of GroupedNodes that contributed to this composed node
}
...
export interface Chapter {
  ...
  confidence?: 'auto-fragment' | 'auto-confirmed' | 'user-edited'; // backend only, never shown to user
}